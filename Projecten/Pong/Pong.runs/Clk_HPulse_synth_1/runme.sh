...
HD_PWD='C:/Users/Piete/OneDrive/Bureaublad/School/2-BasisDigitaleElektronica/Projecten/Pong/Pong.runs/Clk_HPulse_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Clk_HPulse.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Clk_HPulse.tcl
